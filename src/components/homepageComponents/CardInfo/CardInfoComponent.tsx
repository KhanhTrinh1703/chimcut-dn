  ...
  const _rendererCountdown = (props: any): React.ReactNode => {
    ...
    return (
      <div className="flex flex-row mt-2">
        <div className="mr-2">{_renderTimeCard(days, 'Days')}</div>
        <div className="mr-2">{_renderTimeCard(hours, 'Hours')}</div>
        <div className="mr-2">{_renderTimeCard(minutes, 'Minutes')}</div>
        <div className="mr-2">{_renderTimeCard(seconds, 'Seconds')}</div>
      </div>
    )
  }
